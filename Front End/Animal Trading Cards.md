...
0. [Download](https://github.com/udacity/fend-animal-trading-cards/archive/master.zip) and unzip `fend-animal-trading-cards-master.zip` from the downloadables section. Inside, you'll find `card.html`, `styles.css`, `clownfish.jpg`, and the `design-prototype.pdf`.
